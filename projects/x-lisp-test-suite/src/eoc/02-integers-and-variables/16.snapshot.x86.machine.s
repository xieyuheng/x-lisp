...
.data
.align 8
.type isub©variable_info, @object
isub©variable_info:

.size isub©variable_info, . - isub©variable_info
...
isub©setup.body:
        ...
        movq %rax, -88(%rbp)
        movq -88(%rbp), %rax
        movq %rax, isub©constant(%rip)
        jmp isub©setup.epilog
isub©setup.epilog:
        addq $88, %rsp
        popq %r15
        popq %r14
...
.data
.align 8
.type isub©setup©variable_info, @object
isub©setup©variable_info:
        .quad 4
        .quad isub©setup©variable_info.names
.size isub©setup©variable_info, . - isub©setup©variable_info

.data
.align 8
.type isub©setup©variable_info.names, @object
isub©setup©variable_info.names:
        .quad isub©setup©variable_info.names.0
        .quad isub©setup©variable_info.names.1
        .quad isub©setup©variable_info.names.2
        .quad isub©setup©variable_info.names.3
.size isub©setup©variable_info.names, . - isub©setup©variable_info.names

.data
.align 8
.type isub©setup©variable_info.names.0, @object
isub©setup©variable_info.names.0:
        .string "address"
.size isub©setup©variable_info.names.0, . - isub©setup©variable_info.names.0

.data
.align 8
.type isub©setup©variable_info.names.1, @object
isub©setup©variable_info.names.1:
        .string "arity"
.size isub©setup©variable_info.names.1, . - isub©setup©variable_info.names.1

.data
.align 8
.type isub©setup©variable_info.names.2, @object
isub©setup©variable_info.names.2:
        .string "size"
.size isub©setup©variable_info.names.2, . - isub©setup©variable_info.names.2

.data
.align 8
.type isub©setup©variable_info.names.3, @object
isub©setup©variable_info.names.3:
        .string "curry"
.size isub©setup©variable_info.names.3, . - isub©setup©variable_info.names.3
