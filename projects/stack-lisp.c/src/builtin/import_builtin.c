...
void import_builtin(mod_t *mod) {
  ...
  define_primitive_1(mod, "builtin/string-to-int", x_string_to_int);
  define_primitive_1(mod, "builtin/string-to-float", x_string_to_float);
  ...
  define_primitive_2(mod, "builtin/error-with-location", x_error_with_location);

  // sexp

  define_primitive_2(mod, "builtin/parse-located-sexps", x_parse_located_sexps);
  define_primitive_1(mod, "builtin/parse-sexps", x_parse_sexps);
