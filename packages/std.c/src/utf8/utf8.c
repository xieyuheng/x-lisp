...
static code_point_range_t wide_ranges[] = {
...
// Wide code points occupy two columns, every other code point occupies one.
size_t code_point_display_width(code_point_t code_point) {
  size_t count = sizeof(wide_ranges) / sizeof(wide_ranges[0]);
  for (size_t i = 0; i < count; i++) {
    code_point_range_t range = wide_ranges[i];
