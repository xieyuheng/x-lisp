...
(define-code add-forms
  (block entry
    ...
    (add (reg-deref (reg rbp) -8) 5)     ;; 83 /0: mem += imm8
    (add (reg-deref (reg rbp) -8) 1000)  ;; 81 /0: mem += imm32
    (ret)))
...
(define-code sub-forms
  (block entry
    ...
    (sub (reg-deref (reg rbp) -8) 5)     ;; 83 /5: mem -= imm8
    (sub (reg-deref (reg rbp) -8) 1000)  ;; 81 /5: mem -= imm32
    (ret)))
...
(define-code cmp-forms
  (block entry
    ...
    (cmp (reg-deref (reg rbp) -8) 5)     ;; 83 /7: cmp mem, imm8
    (cmp (reg-deref (reg rbp) -8) 1000)  ;; 81 /7: cmp mem, imm32
    (ret)))
