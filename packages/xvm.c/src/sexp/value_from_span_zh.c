...
value_t value_from_span_zh(struct span_t span) {
  ...
  x_array_push_mut(tag, data);
  x_array_push_mut(value_from_position_zh(span.start), data);
  x_array_push_mut(value_from_position_zh(span.end), data);
  return data;
}
...
value_t value_from_source_location_zh(struct source_location_t location) {
  ...
  x_array_push_mut(value_from_span_zh(location.span), data);
  return data;
}