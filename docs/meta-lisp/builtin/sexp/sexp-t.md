...
(claim symbol-sexp-put-content (-> sexp-t symbol-t void-t))
(claim symbol-sexp-put-location (-> sexp-t source-location-t void-t))
...
(claim text-sexp-put-content (-> sexp-t text-t void-t))
(claim text-sexp-put-location (-> sexp-t source-location-t void-t))
...
(claim int-sexp-put-content (-> sexp-t int-t void-t))
(claim int-sexp-put-location (-> sexp-t source-location-t void-t))
...
(claim float-sexp-put-content (-> sexp-t float-t void-t))
(claim float-sexp-put-location (-> sexp-t source-location-t void-t))
...
(claim list-sexp-put-elements (-> sexp-t (list-t sexp-t) void-t))
(claim list-sexp-put-location (-> sexp-t source-location-t void-t))
```
