...
(claim symbol-sexp-put-content (-> sexp-t symbol-t sexp-t))
(claim symbol-sexp-put-location (-> sexp-t source-location-t sexp-t))
...
(claim text-sexp-put-content (-> sexp-t text-t sexp-t))
(claim text-sexp-put-location (-> sexp-t source-location-t sexp-t))
...
(claim int-sexp-put-content (-> sexp-t int-t sexp-t))
(claim int-sexp-put-location (-> sexp-t source-location-t sexp-t))
...
(claim float-sexp-put-content (-> sexp-t float-t sexp-t))
(claim float-sexp-put-location (-> sexp-t source-location-t sexp-t))
...
(claim list-sexp-put-elements (-> sexp-t (list-t sexp-t) sexp-t))
(claim list-sexp-put-location (-> sexp-t source-location-t sexp-t))
```
