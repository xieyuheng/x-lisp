...
to_0_ary_fn(value_t value) {
    assert(address_p(value));
    return (value_0_ary_fn_t *) ((uint64_t) value & PAYLOAD_MASK);
}
...
to_2_ary_fn(value_t value) {
    assert(address_p(value));
    return (value_2_ary_fn_t *) ((uint64_t) value & PAYLOAD_MASK);
}

value_3_ary_fn_t *
to_3_ary_fn(value_t value) {
    assert(address_p(value));
    return (value_3_ary_fn_t *) ((uint64_t) value & PAYLOAD_MASK);
}

value_4_ary_fn_t *
to_4_ary_fn(value_t value) {
    assert(address_p(value));
    return (value_4_ary_fn_t *) ((uint64_t) value & PAYLOAD_MASK);
}

value_5_ary_fn_t *
to_5_ary_fn(value_t value) {
    assert(address_p(value));
    return (value_5_ary_fn_t *) ((uint64_t) value & PAYLOAD_MASK);
}

value_6_ary_fn_t *
to_6_ary_fn(value_t value) {
    assert(address_p(value));
    return (value_6_ary_fn_t *) ((uint64_t) value & PAYLOAD_MASK);
}
